...
public class Telefon extends LinkedList {
    ...
    public Telefon() {
        ...
        this.add(new AbstractMap.SimpleEntry("Rene", "42"));
        this.add(new AbstractMap.SimpleEntry("äöüÄÖÜ", "42"));
        this.add(new AbstractMap.SimpleEntry("van helsing", "42"));
        this.add(new AbstractMap.SimpleEntry("Göärisch", "4321"));
